    ...
    public class OrderGroupController : Controller
    {
        ...
        public async Task<IActionResult> View(int id)
        {
            ...
            if ((await _authorizationService.AuthorizeAsync(User, orderGroup, Policies.View)).Succeeded)
            {
                ...
                model.AllowProcessing = activeRequestGroup.Status == RequestStatus.AcceptedAwaitingApproval && (await _authorizationService.AuthorizeAsync(User, orderGroup, Policies.Accept)).Succeeded;
