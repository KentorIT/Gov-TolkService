...
namespace Tolk.Web.Helpers
{
    public class CssClassHelper
    {
        ...
        {
            return (status == StartListItemStatus.ComplaintEvent || status == StartListItemStatus.RequestArrived || status == StartListItemStatus.RequestReceived || status == StartListItemStatus.RequisitonArrived) ? "blue-border-left" :
