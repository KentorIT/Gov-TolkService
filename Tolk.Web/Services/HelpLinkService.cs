...
namespace Tolk.Web.Services
{
    public class HelpLinkService
    {
        ...
        {
            return new HtmlString($"<a href=\"{GenerateUrl(anchorpoint)}\" aria-label=\"Hjälp från manual\" target=\"_blank\"><span class=\"form-entry-help glyphicon glyphicon-question-sign\"></span></a>");
        }
