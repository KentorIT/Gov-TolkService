    ...
    public class RequisitionModel
    {
        ...
        public  static RequisitionModel GetModelFromRequest(Request request)
        {
            return new RequisitionModel
            {
                ...
                ExpectedEndedAt = request.Order.EndDateTime,
                ExpectedStartedAt = request.Order.StartDateTime,
                SessionEndedAt = request.Order.EndDateTime,
                SessionStartedAt = request.Order.StartDateTime,
