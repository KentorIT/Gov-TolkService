    ...
    public class OrderGroupModel : OrderBaseModel
    {
        ...
        internal static OrderGroupModel GetModelFromOrderGroup(OrderGroup orderGroup, RequestGroup activeRequestGroup, bool displayForBroker = false)
        {
            ...
            var model = new OrderGroupModel
            {
                ...
                TravelConditionHours = EnumHelper.GetContractDefinition(activeRequestGroup?.Ranking.FrameworkAgreement.FrameworkAgreementResponseRuleset).TravelConditionHours,
                TravelConditionKilometers = EnumHelper.GetContractDefinition(activeRequestGroup?.Ranking.FrameworkAgreement.FrameworkAgreementResponseRuleset).TravelConditionKilometers,
