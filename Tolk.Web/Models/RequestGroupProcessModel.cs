    ...
    public class RequestGroupProcessModel : RequestGroupBaseModel
    {
        ...
        internal static RequestGroupProcessModel GetModelFromRequestGroup(RequestGroup requestGroup, Guid fileGroupKey, long combinedMaxSizeAttachments, bool allowDeclineExtraInterpreter)
        {
            ...
            return new RequestGroupProcessModel
            {
                ...
                TravelConditionHours = EnumHelper.GetContractDefinition(requestGroup.Ranking.FrameworkAgreement.FrameworkAgreementResponseRuleset).TravelConditionHours,
                TravelConditionKilometers = EnumHelper.GetContractDefinition(requestGroup.Ranking.FrameworkAgreement.FrameworkAgreementResponseRuleset).TravelConditionKilometers,
