    ...
    public class ApiCallService
    {
        ...
        public async Task GetAllLists()
        {
            using (var client = new HttpClient())
            {
                ...
                var items = JsonConvert.DeserializeObject<List<ListItemModel>>(await response.Content.ReadAsStringAsync());
                ...
                items = JsonConvert.DeserializeObject<List<ListItemModel>>(await response.Content.ReadAsStringAsync());
