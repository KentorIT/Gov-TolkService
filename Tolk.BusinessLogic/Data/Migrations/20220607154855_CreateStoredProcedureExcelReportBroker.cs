...
{
    public partial class CreateStoredProcedureExcelReportBroker : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			migrationBuilder.Sql(@"Exec('CREATE PROCEDURE[dbo].[GetOrderRequestsForExcelReport] @dateFrom DATE, @dateTo DATE, @onlyDelivered BIT, @brokerId INT
AS
...
--NOTE! When ALTER THIS SP - also change file \GOV Tolk\Tolk.BusinessLogic\Data\Stored procedures\GetOrderRequestsForExcelReport.sql
   ...
   UPDATE #reportOrderRequests
	...
	DROP TABLE #reportOrderRequests, #requestStatus, #interpreterLocation, #compLevels');");
        ...
        {
			migrationBuilder.Sql(@"Exec('DROP PROCEDURE GetOrderRequestsForExcelReport;');");
		}
    }
}
