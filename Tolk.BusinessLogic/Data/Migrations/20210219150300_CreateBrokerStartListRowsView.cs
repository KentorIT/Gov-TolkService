...
{
    /// <summary>
    /// This migration is connected to file \Tolk.BusinessLogic\Data\Views\BrokerStartListRows.sql
    /// </summary>
    public partial class CreateBrokerStartListRowsView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"Exec('CREATE VIEW [dbo].[BrokerStartListRows]
AS
...
');");
        ...
        {
            migrationBuilder.Sql("DROP VIEW BrokerStartListRows");
        }
    }
}
