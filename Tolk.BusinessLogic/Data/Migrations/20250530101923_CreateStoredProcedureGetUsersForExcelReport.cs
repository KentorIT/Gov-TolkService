...
{
    /// <inheritdoc />
    public partial class CreateStoredProcedureGetUsersForExcelReport : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"Exec('CREATE PROCEDURE [dbo].[GetUsersForExcelReport] @customerId INT, @userId INT
AS
...
--NOTE! When ALTER THIS SP - also change file \GOV Tolk\Tolk.BusinessLogic\Data\Stored procedures\GetUsersForExcelReport.sql
	...
	DROP TABLE #reportUsers, #userStatus, #customerUnits');");
        ...
        {
            migrationBuilder.Sql(@"Exec('DROP PROCEDURE dbo.GetUsersForExcelReport;');");
        }
    }
}
