...
{
    /// <summary>
    /// This migration is connected to file \Tolk.BusinessLogic\Data\Views\CustomerStartListRows.sql
    /// </summary>
    public partial class CreateCustomerStartListRowsView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"Exec('CREATE VIEW [dbo].[CustomerStartListRows]
AS
...
');");
        ...
        {
            migrationBuilder.Sql("DROP VIEW CustomerStartListRows");
        }
    }
}
