...
{
    public partial class AlterSP_AddFrameworkAgreementTo_GetOrdersForExcelReport : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"Exec('ALTER PROCEDURE[dbo].[GetOrdersForExcelReport] @dateFrom DATE, @dateTo DATE, @userId INT, @onlyDelivered BIT, @customerId INT = NULL
AS
