...
{
    public partial class CreateStoredProceduresExcelReports : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
				migrationBuilder.Sql(@"Exec('CREATE PROCEDURE[dbo].[GetOrdersForExcelReport] @dateFrom DATE, @dateTo DATE, @userId INT, @onlyDelivered BIT, @customerId INT = NULL
AS
...
--NOTE! When ALTER THIS SP - also change file \GOV Tolk\Tolk.BusinessLogic\Data\Stored procedures\GetOrdersForExcelReport.sql
   ...
   UPDATE #reportOrders
	...
	DROP TABLE #reportOrders, #orderStatus, #interpreterLocation, #compLevels');");
			...
			{
				migrationBuilder.Sql(@"Exec('DROP PROCEDURE GetOrdersForExcelReport;');");
			}
		}
	}