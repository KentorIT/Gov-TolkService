...
namespace Tolk.BusinessLogic.Data.Migrations
{
    ...
    [Migration("20230113114108_removableNotificationPOC")]
    partial class removableNotificationPOC
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.OutboundEmail", b =>
                {
                    ...
                    b.Property<int?>("RecipientCustomerUnitId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.RequestNotification", b =>
                {
                    b.Property<int>("RequestNotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RequestNotificationId"), 1L, 1);
                    ...
                    b.HasKey("RequestNotificationId");
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.RequestNotificationEmail", b =>
                {
                    b.Property<int>("RequestNotificationId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RequestNotificationId", "OutboundEmailId");

                    b.HasIndex("OutboundEmailId");

                    b.ToTable("RequestNotificationEmail");
                });

            modelBuilder.Entity("Tolk.BusinessLogic.Entities.RequestNotificationWebhook", b =>
                {
                    b.Property<int>("RequestNotificationId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RequestNotificationId", "OutboundWebhookId");

                    b.HasIndex("OutboundWebhookId");

                    b.ToTable("RequestNotificationWebhook");
                });
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.OutboundEmail", b =>
                {
                    b.HasOne("Tolk.BusinessLogic.Entities.CustomerUnit", "RecipientCustomerUnit")
                        .WithMany()
                    ...
                    b.Navigation("RecipientCustomerUnit");
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.RequestNotificationEmail", b =>
                {
                    b.HasOne("Tolk.BusinessLogic.Entities.OutboundEmail", "OutboundEmail")
                        .WithMany()
                        .HasForeignKey("OutboundEmailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tolk.BusinessLogic.Entities.RequestNotification", "RequestNotification")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("Tolk.BusinessLogic.Entities.RequestNotificationWebhook", b =>
                {
                    b.HasOne("Tolk.BusinessLogic.Entities.OutboundWebHookCall", "OutboundWebhook")
                        .WithMany()
