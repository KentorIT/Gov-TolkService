...
namespace Tolk.BusinessLogic.Utilities
{
    public static class EntityExtensions
    {
        ...
        public static IQueryable<Request> GetRequestsForOrderAgreementCreation(this IQueryable<Request> requests, int customerOrganisationId, DateTime validUseFrom)
            => requests.Where(r =>
                    (r.Status == RequestStatus.Delivered || r.Status == RequestStatus.Approved) &&
                     ...
                     !r.Requisitions.Any() &&
                     r.Order.StartAt >= validUseFrom);

        public static IQueryable<Requisition> GetRequisitionForPeppolMessageCreation(this IQueryable<Requisition> requisitions, int customerOrganisationId, DateTime validUseFrom)
            => requisitions.Where(r =>
                        ...
                        r.Request.Order.StartAt >= validUseFrom);

        public static IQueryable<Requisition> GetAutoGeneratedRequisitionForOrderAgreementCreation(this IQueryable<Requisition> requisitions, int customerOrganisationId, DateTime validUseFrom)
            => requisitions.Where(r =>
